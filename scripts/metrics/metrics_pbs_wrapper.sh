...
print_help() {
    ...
    echo "  -i ICE_TYPE        Ice type: FI, PI, SI, MI"
    echo "  -g BORC2T_TYPE     B- or C-grid method for regridding to T-grid; default Tc; or could be Ta, Tb, Tx, B, BT"
    ...
    echo "  $0 -s gi-mid -t 1e-3 -i FI_B,FI_Tx"
    echo ""
}

# --- Parse arguments ---
while getopts "s:t:i:g:S:E:bzpnh" opt; do
    case ${opt} in
        s) SIM_NAME="$OPTARG" ;;
